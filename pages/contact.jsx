...
export default function ContactPage() {
  return (
    <>
      <Head>
        <title>Contact Us - Cloud Coders</title>
        <meta
          name='description'
          content='Get in touch with Cloud Coders, a student-led coding club at Maranatha High School, through email, social media, and more.'
        />
      </Head>
      ...
      <div className='p-8'>
        ...
        <p className='text-md mb-8 text-gray-700'>
          ...
          collaborate, or just want to say hi, feel free to reach out through
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          ...
          {/* Development Team */}
          <div className='flex items-start p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow'>
            <div className='text-primary font-bold text-2xl mr-4'>
              &#128187;
            </div>
            <div>
