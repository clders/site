...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About - Cloud Coders</title>
        <meta
          name='description'
          content='Learn more about Cloud Coders, a student-led coding club at Maranatha High School, and discover our mission, activities, and location.'
        />
      </Head>
      ...
      <div className='p-8'>
        ...
        <p className='text-md mb-8 text-gray-700'>
          ...
          where students of all experience levels can develop their coding
          skills, collaborate with peers, and engage in tech-driven activities.
        </p>
        ...
        <section className='mb-12'>
          ...
          <p className='text-md mb-4 text-gray-700'>
            If you're looking for a place to grow your coding skills,
            collaborate on exciting projects, or simply meet like-minded peers,
            Cloud Coders is the community for you.
          </p>
        </section>
